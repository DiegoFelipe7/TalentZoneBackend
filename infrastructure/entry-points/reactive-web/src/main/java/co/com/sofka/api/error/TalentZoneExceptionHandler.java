...
@Component
public class TalentZoneExceptionHandler extends AbstractErrorWebExceptionHandler {


    public TalentZoneExceptionHandler(ErrorAttributes errorAttributes, WebProperties resources,
